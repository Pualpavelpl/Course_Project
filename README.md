...
- **Recruiter** создаёт Admin. Admin указывает email и пароль,
  ...
  управляет Attribute и Position, просматривает CV и ставит Likes. То есть, чтобы создать рекрутера это делает Admin и подразумевается в дальнейшем интергация с гугл почтой. Админ скидывает на почту рекрутеру его логин и пароль. Сейчас при создании надо запомнить этот логин и пароль, чтобы потом зайти как рекрутер. Созданный рекрутер логин recruiter@gmail.com пароль 12345678
